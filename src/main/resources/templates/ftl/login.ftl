            ...
            <#--</form>-->
                <div class="other_login">
                    ...
                    <div class="right other_right">
                        <a href="${re.contextPath}/login/qq"><div class="qq-png"></div></a>
                        <a href="${re.contextPath}/login/weixin"><div class="weixin-png"></div></a>
                        <a href="${re.contextPath}/login/weibo"><div class="weibo-png"></div></a>
                    </div>
                </div>
            </div>
        </div>
